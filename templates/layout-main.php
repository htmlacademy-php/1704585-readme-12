    ...
    <body class="page page--main">
        ...
        <div class="header__wrapper page__header-wrapper container">
            ...
            <nav class="header__nav">
                ...
                <li>
                    <a class="header__user-button header__register-button button button--transparent" href="/register.php">Регистрация</a>
                </li>
                </ul>
            </nav>
            </div>
        ...
        <div class="page__main-wrapper page__main-wrapper--intro container">
            ...
            <form class="authorization__form form" action="#" method="post">
                <div class="authorization__input-wrapper form__input-wrapper <?php if (array_key_exists("login", $errors)) :
                ...
                <div class="authorization__input-wrapper form__input-wrapper <?php if (array_key_exists("password", $errors)) :
                    ?> form__input-section--error <?php
                                                                             endif; ?>">
