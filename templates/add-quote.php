<div class="adding-post__input-wrapper form__textarea-wrapper <?php if (array_key_exists("quote", $errors)) :
    ...
    <div class="form__input-section">
        <textarea class="adding-post__textarea adding-post__textarea--quote form__textarea form__input" id="text" name="quote" placeholder="Текст цитаты"><?=getPostVal('quote'); ?></textarea>
...
<div class="adding-post__textarea-wrapper form__input-wrapper <?php if (array_key_exists("author", $errors)) :
    ?> form__input-section--error <?php
                                                              endif; ?>">
