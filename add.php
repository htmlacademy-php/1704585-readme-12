...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!count($errors)) {
        ...
        foreach ($subscribed_users as $subscribed_user) {
            ...
            $subscribed_user['name'] .
            ". Пользователь " . $user['name'] .
            " только что опубликовал новую запись \"" .
            $post['title'] . "\" . Посмотрите её на странице пользователя: ";
            ...
            $message->setBody($message_content . '<a href="http://localhost/profile.php?id=' .
            $user['id'] . '">' . $user['name'] .'</a>', 'text/html');
